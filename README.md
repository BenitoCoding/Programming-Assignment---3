...
# Problem 2 - Operations for Problem 1

In this problem, the students were tasked to use the data frames of Problem 1 and extract the following using subsetting, slicing, and indexing.

<img width="961" height="745" alt="image" src="https://github.com/user-attachments/assets/61af20a7-f0d0-4229-95b2-be72809b8f18" />

The students first loaded the "cars.csv" into the Jupyter Notebook. Similarly to Problem 1, they have the option to display the list as seen on the picture.

<img width="833" height="387" alt="image" src="https://github.com/user-attachments/assets/5e9fb57d-ef53-459a-acaf-be393742787a" />

The "iloc []" allows the student to select a specific row and column using their integer position. This will also slice the column on the specific position.
